...
$banner_large_background = get_field('privacy_policy_banner_large_background');
$banner_small_background = get_field('privacy_policy_banner_small_background');
$banner_title = get_field('privacy_policy_banner_title');
$banner_subtitle = get_field('privacy_policy_banner_subtitle');
?>
 <main class="ANS_main-wrapper">
     ...
     <?php 
	 $short_description = get_field('privacy_policy-short_description');
	 $privacy_policy_lists = get_field('privacy_policy-lists');
	 ?>
      <section class="ANS_term-info-wrap ANS_blog-section-wrap">
      <div class="ANS_container">
		  <?php 
          echo "<p class='fs-base'>{$short_description}</p> <br /> <br />";
            if(!empty($privacy_policy_lists)):
		  		foreach($privacy_policy_lists as $terms):
